  ...
  function (e, t) {
        ...
        (function () {
          ...
          (function (e) {
            ...
            (function () {
              ...
              a("=settings-button", () => T("settings-button")),
                a("=detail-close", () => C()),
                a("=optout-cancel-button", () => C()),
                a(
                  "=close-button",
                  () => (c._ckySetInStore("action", "yes"), void y())
                ),
                a("=donotsell-button", () => T("donotsell-button")),
                a("=reject-button", x("reject")),
                a("=accept-button", x("all")),
                a("=detail-accept-button", x("all")),
                a("=detail-save-button", x()),
                a("=detail-category-preview-save-button", x()),
                a("=optout-confirm-button", x()),
                a("=detail-reject-button", x("reject")),
        ...
        f(),
          (function () {
            for (const e of n._categories)
              "yes" !== c._ckyGetFromStore(e.slug) && j(e);
          })(),
    ...
    function A(e = !1) {
      for (const t of n._categories) {
        ...
        I(
          t,
          "yes" === o || (!o && t.defaultConsent[k()]) || t.isNecessary,
          t.isNecessary,
          n._shortCodes
    ...
    function D(e, t) {
      ...
      r
        ? r.isOverriden
          ...
          : ((r.categories = [c]), (r.isOverriden = !0))
      ...
      return (
        Object.defineProperties(t, {
          src: {
            ...
            set: function (e) {
              return (
                G(t, e) && n("type", "javascript/blocked"), n("src", e), !0
              );
            },
          },
          type: {
        ...
        (t.setAttribute = (e, o) => {
          ...
          n(e, o),
            "data-cookieyes" !== e || G(t) || n("type", "text/javascript");
        }),
        t
      );
    };
    ...
    function G(e, t) {
      return (
        (e.hasAttribute("data-cookieyes") &&
          B(e.getAttribute("data-cookieyes").replace("cookieyes-", ""))) ||
        H(t || e.src)
      );
    }
    function F(e = "") {
